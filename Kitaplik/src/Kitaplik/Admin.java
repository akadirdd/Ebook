...
import Kitaplik_Filter.newpackage.PDFFilter;
...
public class Admin extends javax.swing.JFrame {
    ...
    public DefaultTableModel table2 = new DefaultTableModel() {
        public boolean isCellEditable(int row, int column) {
            return false;//This causes all cells to be not editable
        }
    };
    ...
    public Admin(String kullaniciAdi) {
        ...
        kullaniciId=idDb.kullaniciId(kullaniciAdi);

        System.out.println("Kullanıc önmeli   " + kullaniciAdi);
    ...
    public void frameOzellikleri() {
        this.setTitle("ADMİN SAYFASI");
        this.setResizable(false);
        this.setLocationRelativeTo(null);
        this.setVisible(true);

        jTable1.setModel(table1);
        table1.setColumnIdentifiers(new String[]{"ISBN", "KİTAP ADI", "YAZAR", "YIL", "YAYIN EVİ", "İMAGE URL S", "İMAGE URL M", "İMAGE URL L", "PDF URL"});
        TableColumnModel columnModel1 = jTable1.getColumnModel();
        columnModel1.getColumn(0).setPreferredWidth(1);

        jTable2.setModel(table2);
        table2.setColumnIdentifiers(new String[]{"ID", "KULLANICI ADI", "ŞİFRE", "ROLE", "KONUM", "YAŞ"});
        TableColumnModel columnModel2 = jTable2.getColumnModel();
        columnModel2.getColumn(0).setPreferredWidth(1);
    ...
    public void tabloDoldurKitap() {

        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.tumListeKitaplar();

        for (int i = 0; i < verilerKitap.length; i++) {
            table1.addRow(verilerKitap[i]);
        }
        kitapSayi = verilerKitap.length;
        System.out.println("bitti");

    }

    public void tabloDoldurKullanici() {
        ...
        DataBase dataBase = new DataBase();
        String verilerKullanıcı[][] = dataBase.tumListeKullanıcılar();

        System.out.println("burda");
        for (int i = 0; i < verilerKullanıcı.length; i++) {
            table2.addRow(verilerKullanıcı[i]);
    ...
    public boolean seciliMi1() {
        for (int i = 0; i < table1.getRowCount(); i++) {
            if (jTable1.isRowSelected(i)) {
                isbnKont = String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 0));
                return true;
            }
        }
        return false;
    ...
    public boolean seciliMi2() {
        for (int i = 0; i < table2.getRowCount(); i++) {
            if (jTable2.isRowSelected(i)) {
                secilenId = Integer.valueOf(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 0)));
                return true;
            }
        }
        return false;
    ...
    public String dosyaSec() {
        ...
        jFileChooser.setCurrentDirectory(new File("/home/mucahit/NetBeansProjects/Kitaplik/kitaplar"));
        jFileChooser.setDialogTitle("lusfen dosya seciniz");
    ...
    public void kitapOnerilen() {
        ...
        System.out.println(kullaniciAdi);
        urunOnerme.korelasyon(Integer.valueOf(kullaniciId));
        ...
        for (int i = 0; i < 10; i++) {
            DataBase dataBase = new DataBase();
            System.out.println(kitapDizisi[i] + "gidn");
            verilerKitap[i] = dataBase.onerilenKitap(kitapDizisi[i]);
        }

        System.out.println(verilerKitap[0][7] + "urllll");
    ...
    private void initComponents() {
        ...
        jLabel12.setText("KİTAP ADI");

        jLabel13.setText("YAZAR");

        jLabel14.setText("YIL");

        jLabel15.setText("YAYIN EVİ");

        jLabel16.setText("IMAGE URL S");

        jLabel17.setText("IMAGE URL M");

        jLabel18.setText("IMAGE URL L");

        jLabel19.setText("KİTAP PDF");
        ...
        jButton23.setText("ISBN İLE ARA");
        ...
        jButton24.setText("KİTAP ADI İLE ARA");
        ...
        jButton25.setText("YAZAR İLE ARA");
        ...
        jButton27.setText("YAYIN EVİ İLE ARA");
        ...
        jTabbedPane2.addTab("KİTAP", jPanel2);
        ...
        jLabel62.setText("KULLANICI ADI");

        jLabel63.setText("ŞİFRE");
        ...
        jLabel64.setText("ŞİFRE TEKRAR");

        jLabel65.setText("İLÇE");

        jLabel66.setText("YAŞ");

        jCheckBox1.setText("YÖNETİCİ YETKİSİ");

        jTextField13.setText("jTextField13");

        jTextField14.setText("jTextField14");

        jButton20.setText("KAYDET");
        ...
        jButton22.setText("KULLANICI ADI İLE ARA");
        ...
        jTabbedPane2.addTab("KULLANICI", jPanel3);
        ...
        jTabbedPane1.addTab("YÖNETİM PANELİ", jPanel20);
        ...
        jButton34.setIcon(new javax.swing.ImageIcon("/home/mucahit/NetBeansProjects/Kitaplik/icon/if_circle-arrow-left_173181 (3).png")); // NOI18N
        ...
        jButton35.setIcon(new javax.swing.ImageIcon("/home/mucahit/NetBeansProjects/Kitaplik/icon/if_circle-arrow-right_173182.png")); // NOI18N
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        String verilerKitap[][] = dataBase.kullaniciAdiVeriCek(jTextField11.getText());

        for (int i = 0; i < verilerKitap.length; i++) {
            table2.addRow(verilerKitap[i]);
        }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String location[]=String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 4)).split(", ");
            secilenId = Integer.valueOf(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 0)));
            jTextField10.setText(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 1)));
            jPasswordField1.setText(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 2)));
            jPasswordField2.setText(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 2)));
            jTextField13.setText(location[0]);
            jTextField16.setText(location[1]);
            jTextField17.setText(location[2]);
            jTextField14.setText(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 5)));
            if (String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 5)).equals("guest")) {
                jCheckBox1.setSelected(false);
            } else if (String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 3)).equals("admin")) {
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.yayinEviVeriCek(jTextField12.getText());
        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
        ...
        System.out.println("bitti");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton27ActionPerformed

    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.yilVeriCek(jTextField12.getText());
        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
    ...
    private void jButton25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton25ActionPerformed
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.yazarVeriCek(jTextField12.getText());
        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.kitapAdiVeriCek(jTextField12.getText());
        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        DataBase dataBase = new DataBase();
        String verilerKitap[][] = dataBase.isbnVeriCek(jTextField12.getText());
        for (int i = table1.getRowCount() - 1; i >= 0; i--) {
            table1.removeRow(i);
        }
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("") || jTextField3.getText().equals("")
            ...
            JOptionPane.showMessageDialog(null, "Lütfen Değerleri Boş Bırakmayınız.", "UYARI", JOptionPane.CLOSED_OPTION);
        } else {
            DataBase dataBase = new DataBase();
            dataBase.kitapKayit(jTextField2.getText(), jTextField3.getText(), jTextField4.getText(),
                    jTextField5.getText(), jTextField6.getText(), jTextField7.getText(),
                    jTextField8.getText(), jTextField9.getText(), jTextField1.getText());
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        if (seciliMi1()) {
            isbnKont = String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 0));
            DataBase dataBase = new DataBase();
            dataBase.kitapSil(isbnKont);
        } else {
            System.out.println("Olamdı Malesef.Seçil öge yok");
        }
        temizle1();
        tabloDoldurKitap();
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        if (seciliMi1()) {
            DataBase dataBase = new DataBase();
            dataBase.kitapUpdate(isbnKont, jTextField2.getText(), jTextField3.getText(), jTextField4.getText(),
                    jTextField5.getText(), jTextField6.getText(), jTextField7.getText(),
                    jTextField8.getText(), jTextField9.getText(), jTextField1.getText());
        } else {
            System.out.println("Olamdı Malesef.Seçil öge yok");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if (secilendosya != null) {
            jTextField1.setText(secilendosya);
        } else {
            jTextField1.setText("dosya secmediniz");
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            jTextField2.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 0)));
            jTextField3.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 1)));
            jTextField4.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 2)));
            jTextField5.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 3)));
            jTextField6.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 4)));
            jTextField7.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 5)));
            jTextField8.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 6)));
            jTextField9.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 7)));
            jTextField1.setText(String.valueOf(table1.getValueAt(jTable1.getSelectedRow(), 8)));
        }
    ...
    private void jLabel209MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel209MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel222.getText(), kullaniciAdi);
    ...
    private void jLabel208MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel208MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel223.getText(), kullaniciAdi);
    ...
    private void jLabel210MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel210MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel224.getText(), kullaniciAdi);
    ...
    private void jLabel207MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel207MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel225.getText(), kullaniciAdi);
    ...
    private void jLabel211MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel211MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel226.getText(), kullaniciAdi);
    ...
    private void jLabel212MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel212MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel232.getText(), kullaniciAdi);
    ...
    private void jLabel213MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel213MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel233.getText(), kullaniciAdi);
    ...
    private void jLabel214MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel214MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel234.getText(), kullaniciAdi);
    ...
    private void jLabel215MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel215MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel235.getText(), kullaniciAdi);
    ...
    private void jLabel216MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel216MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel236.getText(), kullaniciAdi);
    }//GEN-LAST:event_jLabel216MouseClicked

    private void jLabel33MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel33MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel132.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel33MouseClicked

    private void jLabel32MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel32MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel133.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel32MouseClicked

    private void jLabel34MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel34MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel134.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel34MouseClicked

    private void jLabel31MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel31MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel135.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel31MouseClicked

    private void jLabel35MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel35MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel136.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel35MouseClicked

    private void jLabel36MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel36MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel142.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel36MouseClicked

    private void jLabel37MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel37MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel143.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel37MouseClicked

    private void jLabel38MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel38MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel144.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel38MouseClicked

    private void jLabel39MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel39MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel145.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel39MouseClicked

    private void jLabel40MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel40MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel146.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel40MouseClicked

    private void jLabel179MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel179MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel192.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel178MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel178MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel193.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel180MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel180MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel194.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel177MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel177MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel195.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel181MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel181MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel196.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel182MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel182MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel202.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel183MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel183MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel203.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel184MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel184MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel204.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel185MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel185MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel205.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel186MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel186MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel206.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel239MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel239MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel252.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel238MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel238MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel253.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel240MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel240MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel254.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel237MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel237MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel255.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel241MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel241MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel256.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel242MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel242MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel262.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel243MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel243MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel263.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel244MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel244MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel264.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel245MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel245MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel265.getText(), kullaniciAdi);        // TODO add your handling code here:
    ...
    private void jLabel246MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel246MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel266.getText(), kullaniciAdi);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel246MouseClicked

    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        if (evt.getClickCount() == 2) {
            System.out.println("double clicked");
            KitapAc kitapAc = new KitapAc(String.valueOf(table3.getValueAt(jTable3.getSelectedRow(), 0)), kullaniciAdi);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jCheckBox1.isSelected()) {
            ...
            kullaniciYetki = "guest";
        }
        dataBase.kullaniciUpdate(secilenId, jTextField10.getText(), jPasswordField1.getText(), kullaniciYetki, jTextField13.getText(), jTextField14.getText());
        tabloDoldurKullanici();
        temizle2();
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        if (seciliMi2()) {
            secilenId = Integer.valueOf(String.valueOf(table2.getValueAt(jTable2.getSelectedRow(), 0)));
            DataBase dataBase = new DataBase();
            dataBase.kullaniciSil(secilenId);
        }
        temizle2();
        tabloDoldurKullanici();
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        if (jTextField10.getText().equals("") || jTextField13.getText().equals("")
                || jTextField14.getText().equals("") || jPasswordField1.getText().equals("") || jPasswordField2.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Kayıt İçin Boş Değer Bırakamazsınız.", "UYARI", JOptionPane.CLOSED_OPTION);
        } else {
            if (jPasswordField1.getText().equals(jPasswordField2.getText())) {
                ...
                String location = jTextField13.getText() + ", " + jTextField16.getText() + ", " + jTextField17.getText();
                dataBase2.kullaniciKayit(jTextField10.getText(), jPasswordField1.getText(), kullaniciYetki, location, jTextField14.getText());
                tabloDoldurKullanici();
                temizle2();
            } else {
                JOptionPane.showMessageDialog(null, "Şifre Uyuşmazlığı", "UYARI", JOptionPane.CLOSED_OPTION);
            }
        }
    }//GEN-LAST:event_jButton20ActionPerformed

    private void jLabel23MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel23MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel82.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel23MouseClicked

    private void jLabel22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel22MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel83.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel22MouseClicked

    private void jLabel24MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel24MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel84.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel24MouseClicked

    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel85.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel21MouseClicked

    private void jLabel25MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel25MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel86.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel25MouseClicked

    private void jLabel26MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel26MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel122.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel26MouseClicked

    private void jLabel27MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel27MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel123.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel27MouseClicked

    private void jLabel28MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel28MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel124.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel28MouseClicked

    private void jLabel29MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel29MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel125.getText(), kullaniciAdi);           // TODO add your handling code here:
    }//GEN-LAST:event_jLabel29MouseClicked

    private void jLabel30MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel30MouseClicked
        KitapAc kitapAc = new KitapAc(jLabel126.getText(), kullaniciAdi);           // TODO add your handling code here:
